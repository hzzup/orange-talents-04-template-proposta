...
@FeignClient(url="localhost:8888", name="cartaoBlock")
public interface BloquearCartao {
	...
	public String bloqueioCartaoLegado(@RequestBody SistemaResponsavel sistemaResponsavel, @PathVariable("id") String cartaoId);
